...
#define WM1811_MIC_IRQ_NUM	(EXYNOS4_IRQ_BOARD_CODEC_START + WM8994_IRQ_MIC1_DET)
#define WM1811_JACKDET_IRQ_NUM	(EXYNOS4_IRQ_BOARD_CODEC_START + WM8994_IRQ_GPIO(6))
